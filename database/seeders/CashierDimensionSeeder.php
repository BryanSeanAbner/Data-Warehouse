...
class CashierDimensionSeeder extends AutoIncrementSeeder
{
    /**
    ...
    {
        DB::table('cashier_dimension')->insert([
            [
                'cashier_key' => 0,
                'cashier_name' => 'Not Applicable',
                'hire_date' => '9999-12-31',
                'shift_type' => 'Not Applicable',
                'hire_source' => 'Not Applicable'
            ],
            [
                'cashier_key' => $this->getIncrement(),
                'cashier_name' => 'Timothy',
                'hire_date' => '2022-10-13',
                'shift_type' => 'Morning',
                'hire_source' => 'LinkedIn'
            ],
            [
                'cashier_key' => $this->getIncrement(),
                'cashier_name' => 'Jeldi',
            ...
            [
                ...
                'shift_type' => 'Evening',
                'hire_source' => 'Instagram'
            ],
            [
                'cashier_key' => $this->getIncrement(),
                'cashier_name' => 'Hendrik',
            ...
            [
                ...
                'shift_type' => 'Evening',
                'hire_source' => 'Refferal'
            ],
            [
                'cashier_key' => $this->getIncrement(),
                'cashier_name' => 'Khalifa',
                'hire_date' => '2022-08-17',
                'shift_type' => 'Morning',
                'hire_source' => 'Refferal'
            ],
            [
