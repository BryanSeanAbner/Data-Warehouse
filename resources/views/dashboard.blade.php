...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 mt-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
            ...
            <!-- Chart Semi Addictive-->
            @if((isset($chartAwal) && !empty($chartAwal)) || (isset($chartAkhir) && !empty($chartAkhir)))
...
<script>
    ...
    let chartAwal = @json($chartAwal ?? null);
    let chartAkhir = @json($chartAkhir ?? null);

    // QUANTITY AWAL HARI
    if (chartAwal) {
        new Chart(document.getElementById('chartAwal'), {
            type: 'bar',
            data: {
